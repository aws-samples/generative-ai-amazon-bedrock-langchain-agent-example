...
1. Before executing the shell script, navigate to your forked version of the _generative-ai-amazon-bedrock-langchain-agent-example_ repository as your working directory and modify the shell script permissions to executable:
...
2. Next, set your Amplify Repository and GitHub PAT environment variables created during the pre-deployment steps:
...
3. Finally, execute the shell script to deploy the [GenAI-FSI-Agent.yml](../cfn/GenAI-FSI-Agent.yml) CloudFormation stack:
...
2. Then copy the [JavaScript plugin](https://dashboard.kommunicate.io/settings/install) generated by Kommunicate:
...
1. Access your Amplify domain URL and continue to [Testing and Validation](../documentation/testing-and-validation.md):
